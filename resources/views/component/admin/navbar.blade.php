                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="e-commerce">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent show" data-bs-parent="#e-commerce" id="admin">
                            <li class="nav-item"><a class="nav-link {{ request()->is('admin/produits/add') ? 'active' : '' }}" href={{url('/admin/produits/add')}}  data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Add product</span>
                                </div>
                              </a>
                              <!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link {{ request()->is('admin/produits') ? 'active' : '' }} " href={{url('/admin/produits')}} data-bs-toggle="" aria-expanded="false">
                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#customer" data-bs-toggle="collapse" aria-expanded="true" aria-controls="e-commerce">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent show" data-bs-parent="#e-commerce" id="customer">
                            <li class="nav-item"><a class="nav-link {{ request()->is('/') ? 'active' : '' }} " href={{url('/')}} data-bs-toggle="" aria-expanded="false">
                  ...
                  <div class="card-footer p-0 border-top">
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                      ...
                      <button class="btn btn-phoenix-secondary d-flex flex-center w-100" type="submit">
                           <a> <span class="me-2" data-feather="log-out">        {{ __('Logout') }}
                            </span></a>
                      </button>
                      </form>
